...
1. Subset of the American Gut Project dataset (healthy dataset) -> `r nrow(AGP)` (total), `r nrow(AGP_healthy_subset)` (healhty) [dataset link](https://qiita.ucsd.edu/study/description/10317)
...
1. Multi-omics of the gut microbial ecosystem in inflammatory bowel diseases, [dataset link](https://qiita.ucsd.edu/study/description/11484) and Metaomics Reveals Microbiome Based Proteolysis as a Driver of Ulcerative Colitis Severity, [dataset link](https://qiita.ucsd.edu/study/description/11549)-> `r nrow(all_IBD)`
3. Guiding longitudinal sampling in inflammatory bowel diseases cohorts -> `r nrow(all_CD_2)` , [dataset link](https://qiita.ucsd.edu/study/description/2538#)
4. Changes in Microbial Ecology after Fecal Microbiota Transplantation for recurrent C. difficile Infection Affected by Underlying Inflammatory Bowel Disease -> `r nrow(all_trans_IBD_CDI)` , [dataset link](https://qiita.ucsd.edu/study/description/10057)
5. Dynamic changes in short- and long-term bacterial composition following fecal microbiota transplantation for recurrent Clostridium difficile infection -> `r nrow(all_C_diff_trans)` , [dataset link](https://qiita.ucsd.edu/study/description/1924)
