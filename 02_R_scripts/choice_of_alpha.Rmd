...
# BMP device
jpeg("importance_plot.jpeg", quality = 100)
...
#use 70% of dataset as healthy population and 30% as healthy samples to test 
sample <- sample(c(TRUE, FALSE), nrow(all_healthy_donors), replace=TRUE, prob=c(0.7,0.3))
healthy_popul  <- all_healthy_donors[sample, ]
healthy_test   <- all_healthy_donors[!sample, ]
